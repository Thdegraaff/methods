...
This second part of the course is about using data to measure **causal** effects. Ideally, we would like an experiment, but almost always we only have observational data on returns to education (aka wages), housing prices or commuting flows. The second part of this course and syllabus with difficulties arising from using observational data to estimate causal effects
