...
This second-order total derivative is negative, implying that the optimum is a unique maximum. We start with solving for the inverse demand curve which  is given by: 
...
Using the first-order condition for utility maximisation, one can also derive the demand curve: 
