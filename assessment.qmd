...
In applied econometrics, the following five threats to the internal validity of regression studies are usually given (in statistics there is a different framework for this, but in most cases they boil down to the same thing)
...
-   obtain better data, but that is bit easy to say;
