...
\begin{figure}
\centering
\includegraphics{_main_files/figure-latex/marginalutility-1.pdf}
...
in 1886, Galton started to research the height of adult children with the height of their parents (Galton 1886). The original data can be seen in the scatterplot in Figure @\ref(fig:galton2). What Galton expected was that the relation between the height of children and that of their parents was one-to-one. On average children should receive the same height of their parents. So, in fact he expected a \(45^{\circ}\) line---the red line; a line with slope equal to 1.
