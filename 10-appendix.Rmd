...
The derivations in Appendices \@ref(apptax) and \@ref(apppricing) follow the methodological approach of @verhoef1996second for deriving implicit tax expressions. For the regulated and unregulated case, it is assumed that an equilibrium exists. For the case without externalities, the adjusted social surplus $AES$ is given by Eq. \@ref(eq:adjsocsur). The Lagrangian function is given by:
