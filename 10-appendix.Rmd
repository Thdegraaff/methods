...
hist(Y), fraction
quietly graph export figures/coin1.svg, replace
```
...
knitr::include_graphics("./figures/coin1.svg")
```
...
hist(Y), fraction
quietly graph export figures/coin100.svg, replace
```
...
knitr::include_graphics("./figures/coin100.svg")
```
